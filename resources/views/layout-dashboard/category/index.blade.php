      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            @else
            <div class="badge bg-danger">Tidak publish</div>
            @endif           
          </td>
          <td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" id="exampleInputnama" required>
            @error('name')
