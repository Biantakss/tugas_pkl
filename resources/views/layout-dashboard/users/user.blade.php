...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <table class="table table-bordered" id="myTable">
      <thead>
        <tr>
          ...
          <th style="text-align: left!important">nomor telepon</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align: left!important">{{ $value->nomor_telepon }}</td> 
          ...
          <td>
           <button type="button" class="btn btn-sm btn-warning btn-edit"
            ...
            <form action="{{route('admin.hapusDataUser')}}" method="POST" class="d-inline delete-form">
              @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.TambahDataUser') }}" method="POST">
          @csrf
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="exampleInputNoTelpon" class="form-label">Nomor Telpon</label>
            <input 
              type="number" 
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{ route('admin.editDataUser') }}" method="POST">
          @csrf
